...
public:
	struct Triangle
	{
		Triangle(size_t v1, size_t v2, size_t v3) { vertex[0] = v1; vertex[1] = v2; vertex[2] = v3; }
		size_t vertex[3];
	};
	...
	void generate_octahedron();
	void subdivide();

private:
	struct MidpointVertex
	{
		MidpointVertex() : v1(0), v2(0) { }
		CL_Vec3f pos;
		size_t v1, v2;
	};
	...
	size_t create_midpoint_vertex(std::vector<MidpointVertex> &new_vertices, size_t v1, size_t v2);
};
