...
public:
	...
	void render_instanced(CL_GraphicContext &gc, const LightModel &light_model, const std::vector<Position> &position, const std::vector<Orientation> &orientation);
...
private:
	...
	CL_ProgramObject program_mirror_object_texture;
	CL_ProgramObject program_mirror_object_no_texture;
	...
	std::vector<CL_Mat4f> matrix_instanced_cache;
};
